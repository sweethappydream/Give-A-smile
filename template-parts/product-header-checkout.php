<section class="product-header">
    <div class="container">
        <div class="custom-breadcrums woocommerce-breadcrumb">
            ...
            foreach ($items as $item => $values) {
                ...
                $productPermalink = strtok($_product->get_permalink(), '?');
                echo "<a href='".$productPermalink."'>" . $_product->get_title() . "</a>";
//                echo '<span>'.$_product->get_title().'</span>';
                break;
            }

            function saveUrlParams($url) {
                if (!$url) return;
        ...
        <div class="product-banner <?= get_field('product_type', get_the_ID()); ?>" style="display: none">
            ...
            <a href="<?= saveUrlParams(get_permalink(817)) ?>" class="product-steps__item active" data-steps-item="1">
            ...
            <a href="<?= saveUrlParams($productPermalink) ?>" class="product-steps__item active" data-steps-item="2">
                <div class="product-steps__item-icon">
                    <div>
        ...
        <div class="product-steps for-me" style="display: none">
            <a href="<?= saveUrlParams($productPermalink) ?>" class="product-steps__item active-m" data-steps-item="1">
                <div class="product-steps__item-icon">
                    <div>
                        <img src="<?= get_template_directory_uri(); ?>/assets/img/sp-icon1.svg" alt="icon1">
                    </div>
