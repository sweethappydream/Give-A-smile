...
<header class="site-header">
    ...
    <div class="container">
        <div class="site-header__row">
            ...
            <div class="site-header__col site-buttons lg-hide">
                ...
                <?php elseif ($isUserLoggedIn): ?>
                    <?php if($wishlistUrl):?>
                        <a class="wish-list-link-header" href="<?=$wishlistUrl; ?>">
                            <?php display_svg(get_template_directory_uri() . '/assets/icon/list.svg'); ?>
                        </a>
                    <?php endif?>
            ...
            <div class="site-header__col site-lang lg-hide">
            ...
            <?php if($isUserLoggedIn && $wishlistUrl):?>
                <a class="wish-list-link-header mobile" href="<?=$wishlistUrl; ?>">
                    <?php display_svg(get_template_directory_uri() . '/assets/icon/list.svg'); ?>
                </a>
            <?php endif?>
        </div>
