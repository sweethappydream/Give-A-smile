...
?>
    <div id="payment" class="woocommerce-checkout-payment">
        ...
        <?php endif; ?>
        <?php
        woocommerce_form_field('sender-name', [
            'type' => 'text',
            'class' => array('form-row-wide'),
            'label' => __('Your Name', THEME_TD),
            'placeholder' => __('Name For Receipt', THEME_TD),
            'required' => true,
        ...
        woocommerce_form_field('billing_phone', [
            'type' => 'tel',
            'class' => array('form-row-wide'),
            'label' => __('Phone Number', THEME_TD),
            'placeholder' => __('054..', THEME_TD),
            'required' => true,
            'default' => $checkout->get_value('billing_phone') ?: '',
        ], $checkout->get_value('billing_phone'));

        $current_user = wp_get_current_user();

        woocommerce_form_field('receipt_email', [
            'type' => 'email',
            'class' => array('form-row-wide'),
            'label' => __('Email for Receipt', THEME_TD),
            'placeholder' => __('Enter an email', THEME_TD),
            'required' => true,
            'default' => $current_user->user_email ?: '',
        ], $checkout->get_value('receipt_email'));
        ?>
