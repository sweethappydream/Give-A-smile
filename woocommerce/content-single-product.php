...
<div id="product-<?php the_ID(); ?>"
     data-product-id="<?php the_ID(); ?>" <?php wc_product_class($product_type, $product); ?>>
        ...
        <div class="container">
            <div class="product-banner <?= get_field('product_type', get_the_ID()); ?>" style="display: none">
                ...
                <div class="product-banner__image">
                    <div class="image"
                         style="background-image: url(<?= wp_get_attachment_url($product->get_image_id()); ?>)"></div>
                </div>
            </div>
            <div class="product-steps">
                ...
                <a href="#" class="product-steps__item" data-steps-item="2">
                    <div class="product-steps__item-icon">
                        <div>
                ...
                <a href="#" class="product-steps__item" data-steps-item="3">
                    <div class="product-steps__item-icon">
                        <div>
    ...
    <div class="container">
        <section class="steps-list" style="min-height: 500px;">
            <?php include(locate_template('template-parts/card-steps/step_1.php')); ?>
            <?php include(locate_template('template-parts/card-steps/step_2.php')); ?>
            <?php include(locate_template('template-parts/card-steps/step_3.php')); ?>
            <?php include(locate_template('template-parts/card-steps/step_4.php')); ?>
            <?php include(locate_template('template-parts/card-steps/step_5.php')); ?>
        </section>
    </div>
</div>
