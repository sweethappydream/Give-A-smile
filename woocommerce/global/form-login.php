...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ($hidden) ? 'style="display:none;"' : ''; ?>>
    ...
    <p class="form-row form-row-first input-before input-before--mail">
        ...
        <input type="text" class="input-text" name="username" id="username" autocomplete="username" aria-label="username or email" placeholder="<?= $email ?: __('Email or Username', 'woocommerce') ?>" />
    </p>
    ...
    <p class="form-row form-row--flex form-row--last">
        <input class="woocommerce-form__input woocommerce-form__input-checkbox visually-hidden" name="rememberme" type="checkbox" id="rememberme" value="forever" />
