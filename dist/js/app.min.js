							...
							s
								.post(
									...
									function (t) {
										...
										const has_more = t?.has_load_more;
										s(".partners__gifts .gifts").html(data);
										if( has_more ) {
											s(".partners__gifts").find('.load-more-btn').show();
											s(".partners__gifts").find('.load-more-btn').data('page', 5);
										} else {
											s(".partners__gifts").find('.load-more-btn').hide();
										}
									}
								)
								.always(function () {
