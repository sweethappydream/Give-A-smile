...
***************************************************************************** */ function d(
      ...
      <text x="50%" y="${a}%" fill="#997C61" font-size="${e}" dominant-baseline="middle"
      ...
      text-anchor="middle" id="show-price-svg"></text>`),
			...
			svgTextMultiline: (
				...
				if (null !== v) {
							...
							(("message-svg" !== u && "partner-desc-svg" !== u) ||
								((i =
									"message-svg" === u
										...
										: v.clientWidth / 1.4),
								(l = 4 < r && r < 6 ? 7 : 1.4 * r)),
							(L.innerHTML = '<tspan id="temp"></tspan >'),
							[]);
					for (let e = 0; e < w.length; e++) {
						var x = d + w[e] + " ";
						let t = document.getElementById("temp");
						t.innerHTML = x;
						var C = t.getBoundingClientRect().width;
						d =
							C > i && 0 < e
								? ((L.innerHTML +=
					...
					"partner-desc-svg" === u ? S() : "message-svg" === u && S(3.1),
						(L.innerHTML +=
							'<tspan x="' + a + '%" dy="' + l + '">' + d + "</tspan>"),
